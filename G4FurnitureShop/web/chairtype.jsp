<%-- 
    Document   : chairtype
    Created on : Oct 21, 2020, 9:31:33 AM
    Author     : Admin
--%>
        ...
        <div class="container">
            <section class="header mt-3 row">
                ...
                <ol class="breadcrumb px-0">
                    <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><%out.print(rs.getProducttype_name());%></li>
                </ol>
            </nav>
            ...
            <div class="row px-0">
                <div id="row-tittle" class="col-12">
                    <h4><%out.print(rs.getProducttype_name());%></h4>
                </div>               
                <%  productlistDAO proDAO = new productlistDAO();
                    ...
                    for (productlist item : list) {
                        ...
                        out.println("<img style='height:250px;' class=\"img-prd card-img-top\" src=\"images/product/" + item.getImages() + "\" alt=\"Product\"/>");
                        out.println("</a>");
